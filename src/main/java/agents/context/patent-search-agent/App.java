package cloudcode.patentsearch.web;
...
public class App {
  ...
  static String VECTOR_SEARCH_ENDPOINT = "https://us-central1-**********.cloudfunctions.net/patent-search"; //Make sure you have the Cloud Run Function deployed for this.
    ...
    try{
     ...
     System.out.println(previousResults);
      if(!(previousResults.isEmpty())) {
        ...
        String[] patentIds = patents.split("\n\n\n\n"); //This is because we have the Cloud Run Function return a string of patents mathing the user's search text
